...
- [VM (자바스크립트 실행)](#vm-자바스크립트-실행)
    ...
    - [클래스: `vm.SourceTextModule`](#클래스-vmsourcetextmodule)
    ...
    - [클래스: `vm.SyntheticModule`](#클래스-vmsyntheticmodule)
    ...
    - [컴파일 API에서 동적 `import()` 지원](#컴파일-api에서-동적-import-지원)
      - [`importModuleDynamically`가 `vm.constants.USE_MAIN_CONTEXT_DEFAULT_LOADER`일 때](#importmoduledynamically가-vmconstantsuse_main_context_default_loader일-때)
      - [`importModuleDynamically`가 함수일 때](#importmoduledynamically가-함수일-때)
