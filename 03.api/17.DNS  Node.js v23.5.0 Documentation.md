...
- [DNS](#dns)
    - [클래스: `dns.Resolver`](#클래스-dnsresolver)
      - [`Resolver([options])`](#resolveroptions)
      - [`resolver.cancel()`](#resolvercancel)
      - [`resolver.setLocalAddress(ipv4)`](#resolversetlocaladdressipv4)
    ...
    - [DNS Promises API](#dns-promises-api)
      - [클래스: `dnsPromises.Resolver`](#클래스-dnspromisesresolver)
      - [`resolver.cancel()`](#resolvercancel)
    ...
    - [구현 시 고려사항](#구현-시-고려사항)
      ...
      - [`dns.resolve()`, `dns.resolve*()`, 그리고 `dns.reverse()`](#dnsresolve-dnsresolve-그리고-dnsreverse)
