...
- [생성된 스냅샷을 로드하고 index.js에서 애플리케이션을 시작합니다.](#생성된-스냅샷을-로드하고-indexjs에서-애플리케이션을-시작합니다)
      ...
      - [`--entry-url`](#--entry-url)
      - [`--env-file-if-exists=config`](#--env-file-if-existsconfig)
...
- [이 부분은 주석입니다 PORT=3000 # 이 부분도 주석입니다](#이-부분은-주석입니다-port3000--이-부분도-주석입니다)
      ...
      - [`--experimental-async-context-frame`](#--experimental-async-context-frame)
      ...
      - [`--experimental-test-isolation=mode`](#--experimental-test-isolationmode)
      ...
      - [`--report-dir=디렉토리`, `report-directory=디렉토리`](#--report-dir디렉토리-report-directory디렉토리)
...
- [다음과 동일합니다:](#다음과-동일합니다)
    ...
    - [유용한 V8 옵션](#유용한-v8-옵션)
      ...
      - [`--max-semi-space-size=SIZE` (MiB 단위)](#--max-semi-space-sizesize-mib-단위)
