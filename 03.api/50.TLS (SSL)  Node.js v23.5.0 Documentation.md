...
- [TLS (SSL)](#tls-ssl)
    ...
    - [TLS/SSL 개념](#tlsssl-개념)
      ...
      - [세션 재개(Session Resumption)](#세션-재개session-resumption)
        - [세션 식별자](#세션-식별자)
        - [세션 티켓[#](https://nodejs.org/docs/latest/api/tls.html#session-tickets)](#세션-티켓httpsnodejsorgdocslatestapitlshtmlsession-tickets)
    - [기본 TLS 암호화 스위트 수정하기](#기본-tls-암호화-스위트-수정하기)
    - [OpenSSL 보안 레벨](#openssl-보안-레벨)
      - [보안 수준 설정하기](#보안-수준-설정하기)
      - [[`--tls-cipher-list` 사용하기](https://nodejs.org/docs/latest/api/cli.html#--tls-cipher-listlist)[#](https://nodejs.org/docs/latest/api/tls.html#using---tls-cipher-list)](#--tls-cipher-list-사용하기httpsnodejsorgdocslatestapiclihtml--tls-cipher-listlisthttpsnodejsorgdocslatestapitlshtmlusing---tls-cipher-list)
    - [X509 인증서 오류 코드](#x509-인증서-오류-코드)
    - [클래스: `tls.CryptoStream`[#](https://nodejs.org/docs/latest/api/tls.html#class-tlscryptostream)](#클래스-tlscryptostreamhttpsnodejsorgdocslatestapitlshtmlclass-tlscryptostream)
      - [`cryptoStream.bytesWritten`[#](https://nodejs.org/docs/latest/api/tls.html#cryptostreambyteswritten)](#cryptostreambyteswrittenhttpsnodejsorgdocslatestapitlshtmlcryptostreambyteswritten)
    - [클래스: `tls.SecurePair`[#](https://nodejs.org/docs/latest/api/tls.html#class-tlssecurepair)](#클래스-tlssecurepairhttpsnodejsorgdocslatestapitlshtmlclass-tlssecurepair)
      - [이벤트: `'secure'`[#](https://nodejs.org/docs/latest/api/tls.html#event-secure)](#이벤트-securehttpsnodejsorgdocslatestapitlshtmlevent-secure)
    - [클래스: `tls.Server`[#](https://nodejs.org/docs/latest/api/tls.html#class-tlsserver)](#클래스-tlsserverhttpsnodejsorgdocslatestapitlshtmlclass-tlsserver)
      - [이벤트: `'connection'`[#](https://nodejs.org/docs/latest/api/tls.html#event-connection)](#이벤트-connectionhttpsnodejsorgdocslatestapitlshtmlevent-connection)
      - [이벤트: `'keylog'`[#](https://nodejs.org/docs/latest/api/tls.html#event-keylog)](#이벤트-keyloghttpsnodejsorgdocslatestapitlshtmlevent-keylog)
      - [이벤트: `'newSession'`](#이벤트-newsession)
      - [이벤트: `'OCSPRequest'`[#](https://nodejs.org/docs/latest/api/tls.html#event-ocsprequest)](#이벤트-ocsprequesthttpsnodejsorgdocslatestapitlshtmlevent-ocsprequest)
      - [이벤트: `'resumeSession'`[#](https://nodejs.org/docs/latest/api/tls.html#event-resumesession)](#이벤트-resumesessionhttpsnodejsorgdocslatestapitlshtmlevent-resumesession)
      - [이벤트: `'secureConnection'`[#](https://nodejs.org/docs/latest/api/tls.html#event-secureconnection)](#이벤트-secureconnectionhttpsnodejsorgdocslatestapitlshtmlevent-secureconnection)
      - [이벤트: `'tlsClientError'`[#](https://nodejs.org/docs/latest/api/tls.html#event-tlsclienterror)](#이벤트-tlsclienterrorhttpsnodejsorgdocslatestapitlshtmlevent-tlsclienterror)
      - [`server.addContext(hostname, context)`[#](https://nodejs.org/docs/latest/api/tls.html#serveraddcontexthostname-context)](#serveraddcontexthostname-contexthttpsnodejsorgdocslatestapitlshtmlserveraddcontexthostname-context)
      - [`server.address()`[#](https://nodejs.org/docs/latest/api/tls.html#serveraddress)](#serveraddresshttpsnodejsorgdocslatestapitlshtmlserveraddress)
      - [`server.close([callback])`[#](https://nodejs.org/docs/latest/api/tls.html#serverclosecallback)](#serverclosecallbackhttpsnodejsorgdocslatestapitlshtmlserverclosecallback)
      - [`server.getTicketKeys()`[#](https://nodejs.org/docs/latest/api/tls.html#servergetticketkeys)](#servergetticketkeyshttpsnodejsorgdocslatestapitlshtmlservergetticketkeys)
      - [`server.listen()`[#](https://nodejs.org/docs/latest/api/tls.html#serverlisten)](#serverlistenhttpsnodejsorgdocslatestapitlshtmlserverlisten)
      - [`server.setSecureContext(options)`[#](https://nodejs.org/docs/latest/api/tls.html#serversetsecurecontextoptions)](#serversetsecurecontextoptionshttpsnodejsorgdocslatestapitlshtmlserversetsecurecontextoptions)
      - [`server.setTicketKeys(keys)`[#](https://nodejs.org/docs/latest/api/tls.html#serversetticketkeyskeys)](#serversetticketkeyskeyshttpsnodejsorgdocslatestapitlshtmlserversetticketkeyskeys)
    - [클래스: `tls.TLSSocket`[#](https://nodejs.org/docs/latest/api/tls.html#class-tlstlssocket)](#클래스-tlstlssockethttpsnodejsorgdocslatestapitlshtmlclass-tlstlssocket)
      - [`new tls.TLSSocket(socket[, options])`[#](https://nodejs.org/docs/latest/api/tls.html#new-tlstlssocketsocket-options)](#new-tlstlssocketsocket-optionshttpsnodejsorgdocslatestapitlshtmlnew-tlstlssocketsocket-options)
      - [이벤트: `'keylog'`[#](https://nodejs.org/docs/latest/api/tls.html#event-keylog_1)](#이벤트-keyloghttpsnodejsorgdocslatestapitlshtmlevent-keylog_1)
      - [이벤트: `'OCSPResponse'`[#](https://nodejs.org/docs/latest/api/tls.html#event-ocspresponse)](#이벤트-ocspresponsehttpsnodejsorgdocslatestapitlshtmlevent-ocspresponse)
      - [이벤트: `'secureConnect'`[#](https://nodejs.org/docs/latest/api/tls.html#event-secureconnect)](#이벤트-secureconnecthttpsnodejsorgdocslatestapitlshtmlevent-secureconnect)
      - [이벤트: `'session'`[#](https://nodejs.org/docs/latest/api/tls.html#event-session)](#이벤트-sessionhttpsnodejsorgdocslatestapitlshtmlevent-session)
      - [`tlsSocket.address()`[#](https://nodejs.org/docs/latest/api/tls.html#tlssocketaddress)](#tlssocketaddresshttpsnodejsorgdocslatestapitlshtmltlssocketaddress)
      - [`tlsSocket.authorizationError`](#tlssocketauthorizationerror)
      - [`tlsSocket.authorized`[#](https://nodejs.org/docs/latest/api/tls.html#tlssocketauthorized)](#tlssocketauthorizedhttpsnodejsorgdocslatestapitlshtmltlssocketauthorized)
      - [`tlsSocket.disableRenegotiation()`[#](https://nodejs.org/docs/latest/api/tls.html#tlssocketdisablerenegotiation)](#tlssocketdisablerenegotiationhttpsnodejsorgdocslatestapitlshtmltlssocketdisablerenegotiation)
      - [`tlsSocket.enableTrace()`[#](https://nodejs.org/docs/latest/api/tls.html#tlssocketenabletrace)](#tlssocketenabletracehttpsnodejsorgdocslatestapitlshtmltlssocketenabletrace)
      - [`tlsSocket.encrypted`[#](https://nodejs.org/docs/latest/api/tls.html#tlssocketencrypted)](#tlssocketencryptedhttpsnodejsorgdocslatestapitlshtmltlssocketencrypted)
      - [`tlsSocket.exportKeyingMaterial(length, label[, context])`[#](https://nodejs.org/docs/latest/api/tls.html#tlssocketexportkeyingmateriallength-label-context)](#tlssocketexportkeyingmateriallength-label-contexthttpsnodejsorgdocslatestapitlshtmltlssocketexportkeyingmateriallength-label-context)
      - [`tlsSocket.getCertificate()`[#](https://nodejs.org/docs/latest/api/tls.html#tlssocketgetcertificate)](#tlssocketgetcertificatehttpsnodejsorgdocslatestapitlshtmltlssocketgetcertificate)
      - [`tlsSocket.getCipher()`[#](https://nodejs.org/docs/latest/api/tls.html#tlssocketgetcipher)](#tlssocketgetcipherhttpsnodejsorgdocslatestapitlshtmltlssocketgetcipher)
      - [`tlsSocket.getEphemeralKeyInfo()`[#](https://nodejs.org/docs/latest/api/tls.html#tlssocketgetephemeralkeyinfo)](#tlssocketgetephemeralkeyinfohttpsnodejsorgdocslatestapitlshtmltlssocketgetephemeralkeyinfo)
      - [`tlsSocket.getFinished()`[#](https://nodejs.org/docs/latest/api/tls.html#tlssocketgetfinished)](#tlssocketgetfinishedhttpsnodejsorgdocslatestapitlshtmltlssocketgetfinished)
      - [`tlsSocket.getPeerCertificate([detailed])`[#](https://nodejs.org/docs/latest/api/tls.html#tlssocketgetpeercertificatedetailed)](#tlssocketgetpeercertificatedetailedhttpsnodejsorgdocslatestapitlshtmltlssocketgetpeercertificatedetailed)
        - [Certificate 객체](#certificate-객체)
      - [`tlsSocket.getPeerFinished()`[#](https://nodejs.org/docs/latest/api/tls.html#tlssocketgetpeerfinished)](#tlssocketgetpeerfinishedhttpsnodejsorgdocslatestapitlshtmltlssocketgetpeerfinished)
      - [`tlsSocket.getPeerX509Certificate()`[#](https://nodejs.org/docs/latest/api/tls.html#tlssocketgetpeerx509certificate)](#tlssocketgetpeerx509certificatehttpsnodejsorgdocslatestapitlshtmltlssocketgetpeerx509certificate)
      - [`tlsSocket.getProtocol()`[#](https://nodejs.org/docs/latest/api/tls.html#tlssocketgetprotocol)](#tlssocketgetprotocolhttpsnodejsorgdocslatestapitlshtmltlssocketgetprotocol)
      - [`tlsSocket.getSession()`[#](https://nodejs.org/docs/latest/api/tls.html#tlssocketgetsession)](#tlssocketgetsessionhttpsnodejsorgdocslatestapitlshtmltlssocketgetsession)
      - [`tlsSocket.getSharedSigalgs()`[#](https://nodejs.org/docs/latest/api/tls.html#tlssocketgetsharedsigalgs)](#tlssocketgetsharedsigalgshttpsnodejsorgdocslatestapitlshtmltlssocketgetsharedsigalgs)
      - [`tlsSocket.getTLSTicket()`[#](https://nodejs.org/docs/latest/api/tls.html#tlssocketgettlsticket)](#tlssocketgettlstickethttpsnodejsorgdocslatestapitlshtmltlssocketgettlsticket)
      - [`tlsSocket.getX509Certificate()`[#](https://nodejs.org/docs/latest/api/tls.html#tlssocketgetx509certificate)](#tlssocketgetx509certificatehttpsnodejsorgdocslatestapitlshtmltlssocketgetx509certificate)
      - [`tlsSocket.isSessionReused()`[#](https://nodejs.org/docs/latest/api/tls.html#tlssocketissessionreused)](#tlssocketissessionreusedhttpsnodejsorgdocslatestapitlshtmltlssocketissessionreused)
      - [`tlsSocket.localAddress`[#](https://nodejs.org/docs/latest/api/tls.html#tlssocketlocaladdress)](#tlssocketlocaladdresshttpsnodejsorgdocslatestapitlshtmltlssocketlocaladdress)
      - [`tlsSocket.localPort`[#](https://nodejs.org/docs/latest/api/tls.html#tlssocketlocalport)](#tlssocketlocalporthttpsnodejsorgdocslatestapitlshtmltlssocketlocalport)
      - [`tlsSocket.remoteAddress`[#](https://nodejs.org/docs/latest/api/tls.html#tlssocketremoteaddress)](#tlssocketremoteaddresshttpsnodejsorgdocslatestapitlshtmltlssocketremoteaddress)
      - [`tlsSocket.remoteFamily`[#](https://nodejs.org/docs/latest/api/tls.html#tlssocketremotefamily)](#tlssocketremotefamilyhttpsnodejsorgdocslatestapitlshtmltlssocketremotefamily)
      - [`tlsSocket.remotePort`[#](https://nodejs.org/docs/latest/api/tls.html#tlssocketremoteport)](#tlssocketremoteporthttpsnodejsorgdocslatestapitlshtmltlssocketremoteport)
      - [`tlsSocket.renegotiate(options, callback)`[#](https://nodejs.org/docs/latest/api/tls.html#tlssocketrenegotiateoptions-callback)](#tlssocketrenegotiateoptions-callbackhttpsnodejsorgdocslatestapitlshtmltlssocketrenegotiateoptions-callback)
      - [`tlsSocket.setKeyCert(context)`[#](https://nodejs.org/docs/latest/api/tls.html#tlssocketsetkeycertcontext)](#tlssocketsetkeycertcontexthttpsnodejsorgdocslatestapitlshtmltlssocketsetkeycertcontext)
      - [`tlsSocket.setMaxSendFragment(size)`[#](https://nodejs.org/docs/latest/api/tls.html#tlssocketsetmaxsendfragmentsize)](#tlssocketsetmaxsendfragmentsizehttpsnodejsorgdocslatestapitlshtmltlssocketsetmaxsendfragmentsize)
    ...
    - [`tls.connect(path[, options][, callback])`[#](https://nodejs.org/docs/latest/api/tls.html#tlsconnectpath-options-callback)](#tlsconnectpath-options-callbackhttpsnodejsorgdocslatestapitlshtmltlsconnectpath-options-callback)
    - [`tls.connect(port[, host][, options][, callback])`[#](https://nodejs.org/docs/latest/api/tls.html#tlsconnectport-host-options-callback)](#tlsconnectport-host-options-callbackhttpsnodejsorgdocslatestapitlshtmltlsconnectport-host-options-callback)
    ...
    - [`tls.getCiphers()`[#](https://nodejs.org/docs/latest/api/tls.html#tlsgetciphers)](#tlsgetciphershttpsnodejsorgdocslatestapitlshtmltlsgetciphers)
    - [`tls.rootCertificates`[#](https://nodejs.org/docs/latest/api/tls.html#tlsrootcertificates)](#tlsrootcertificateshttpsnodejsorgdocslatestapitlshtmltlsrootcertificates)
    - [`tls.DEFAULT_ECDH_CURVE`[#](https://nodejs.org/docs/latest/api/tls.html#tlsdefault_ecdh_curve)](#tlsdefault_ecdh_curvehttpsnodejsorgdocslatestapitlshtmltlsdefault_ecdh_curve)
    - [`tls.DEFAULT_MAX_VERSION`[#](https://nodejs.org/docs/latest/api/tls.html#tlsdefault_max_version)](#tlsdefault_max_versionhttpsnodejsorgdocslatestapitlshtmltlsdefault_max_version)
    - [`tls.DEFAULT_MIN_VERSION`[#](https://nodejs.org/docs/latest/api/tls.html#tlsdefault_min_version)](#tlsdefault_min_versionhttpsnodejsorgdocslatestapitlshtmltlsdefault_min_version)
    - [`tls.DEFAULT_CIPHERS`[#](https://nodejs.org/docs/latest/api/tls.html#tlsdefault_ciphers)](#tlsdefault_ciphershttpsnodejsorgdocslatestapitlshtmltlsdefault_ciphers)
