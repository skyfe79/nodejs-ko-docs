...
- [TLS (SSL)](#tls-ssl)
    ...
    - [`tls.connect(path, options)`](#tlsconnectpath-options)
    - [`tls.connect(port, host[, callback])`](#tlsconnectport-host-callback)
    - [`tls.createSecureContext([options])`](#tlscreatesecurecontextoptions)
    - [`tls.createSecurePair(context, requestCert[, options])`](#tlscreatesecurepaircontext-requestcert-options)
    - [`tls.createServer(options)`](#tlscreateserveroptions)
