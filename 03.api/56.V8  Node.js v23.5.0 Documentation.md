...
- [V8](#v8)
    ...
    - [직렬화 API](#직렬화-api)
      ...
      - [클래스: `v8.Serializer`](#클래스-v8serializer)
    ...
    - [`serializer.writeRawBytes(buffer)`](#serializerwriterawbytesbuffer)
      ...
      - [클래스: `v8.Deserializer`](#클래스-v8deserializer)
    ...
    - [`deserializer._readHostObject()`](#deserializer_readhostobject)
      - [클래스: `v8.DefaultSerializer`](#클래스-v8defaultserializer)
      - [클래스: `v8.DefaultDeserializer`](#클래스-v8defaultdeserializer)
    ...
    - [클래스: `v8.GCProfiler`](#클래스-v8gcprofiler)
