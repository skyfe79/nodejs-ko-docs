...
- [Worker 스레드](#worker-스레드)
    ...
    - [`worker.postMessageToThread(threadId, value, transferList)`](#workerpostmessagetothreadthreadid-value-transferlist)
    ...
    - [클래스: `MessageChannel`](#클래스-messagechannel)
    - [클래스: `MessagePort`](#클래스-messageport)
      - [이벤트: `'close'`](#이벤트-close)
      - [이벤트: `'message'`](#이벤트-message)
      - [이벤트: `'messageerror'`](#이벤트-messageerror)
    ...
    - [Notes](#notes)
      - [stdio의 동기적 블로킹](#stdio의-동기적-블로킹)
      - [preload 스크립트에서 worker 스레드 실행하기](#preload-스크립트에서-worker-스레드-실행하기)
