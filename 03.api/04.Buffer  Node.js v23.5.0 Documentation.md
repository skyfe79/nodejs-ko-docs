...
- [Buffer](#buffer)
    ...
    - [클래스: `Buffer`](#클래스-buffer)
      ...
      - [`buf.includes(value, byteOffset)`](#bufincludesvalue-byteoffset)
      - [`buf.indexOf(value, byteOffset)`](#bufindexofvalue-byteoffset)
      - [`buf.keys()`](#bufkeys)
      - [`buf.lastIndexOf(value, byteOffset)`](#buflastindexofvalue-byteoffset)
