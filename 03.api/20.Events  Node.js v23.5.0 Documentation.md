...
- [이벤트](#이벤트)
    ...
    - [클래스: `EventEmitter`](#클래스-eventemitter)
      - [이벤트: `'newListener'`](#이벤트-newlistener)
      - [이벤트: `'removeListener'`](#이벤트-removelistener)
      ...
      - [`emitterSymbol.for('nodejs.rejection')`](#emittersymbolfornodejsrejection)
    ...
    - [클래스: `events.EventEmitterAsyncResource extends EventEmitter`](#클래스-eventseventemitterasyncresource-extends-eventemitter)
    ...
    - [`EventTarget`과 `Event` API](#eventtarget과-event-api)
      ...
      - [이벤트 리스너](#이벤트-리스너)
      - [`EventTarget` 오류 처리](#eventtarget-오류-처리)
      - [클래스: `Event`](#클래스-event)
    ...
    - [`eventTarget.addEventListener(type, listener[, options])`](#eventtargetaddeventlistenertype-listener-options)
      ...
      - [클래스: `CustomEvent`](#클래스-customevent)
        - [`event.detail`](#eventdetail)
      - [클래스: `NodeEventTarget`](#클래스-nodeeventtarget)
